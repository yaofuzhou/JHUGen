...
real(8), public :: etajet_max = 999d0                         ! jet max eta
...
real(8), public :: pTlepton_min = 10d0*GeV
real(8), public :: etalepton_max = 2.5d0
!=====================================================

!=====================================================
!constants
real(8), public            :: M_Top   = 1.7320000000000000d0      ! top quark mass
